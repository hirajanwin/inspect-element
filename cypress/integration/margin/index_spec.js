...
describe('margin', () => {
  it('should works', () => {
    ...
    cy.get('#inspect-element-margin')
      .should('have.css', 'width', '30px')
      .should('have.css', 'height', '40px')
      .should('have.css', 'border-top-width', '110px')
      .should('have.css', 'border-right-width', '111px')
      .should('have.css', 'border-bottom-width', '112px')
      .should('have.css', 'border-left-width', '113px')
